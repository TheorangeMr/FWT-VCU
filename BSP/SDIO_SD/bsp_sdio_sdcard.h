...
********************************************************************************
    ...
    *文件名：bsp_sdio_sdcard.h
    *版  本：v1.0
    *日  期：2020.12.09
    *作  者：王峰
    *说  明：本文件是对ST固件库中的stm32_eval_sdio_sd.h和stm3210e_eval.h的整合
...
/*              以下宏定义来自stm3210e_eval.h                */

#define SD_DETECT_PIN                    GPIO_Pin_7                  /* 设置PC.7为SD卡插入检测引脚 */
